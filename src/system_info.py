    ...
    def export_info(self):
        try:
            ...
            if format_choice == 'txt':
                ...
                content += f"Generated by: {os.getlogin()}\n"
                content += f"Hostname: {platform.node()}\n"
                content += "="*50 + "\n\n"
                ...
                for section_name, items in [
                    ...
                    ("Hardware Information", hardware_info_list),
                    ("Network Information", network_info_list)
                ]:
                    content += f"\n{section_name}\n"
                ...
                # Add single footer line
                content += "\nGenerated by _a2a (Linux System Info Tool) | © PearlK Tech"
                
                export_data = content
            
            else:
                # HTML format with proper string formatting
...
<body>
    ...
    <div class="nav-menu no-print">
        ...
        <ul>
            ...
            <li><a href="#hardware-info">Hardware Information</a></li>
...
"""
                ...
                # Add sections with proper table formatting
                for section_id, section_name, items in [
                    ("system-info", "System Information", system_info),
                    ("hardware-info", "Hardware Information", hardware_info_list),
                    ("network-info", "Network Information", network_info_list)
                ]:
                    content += f'<div class="section" id="{section_id}">\n'
                    content += f'<h2 class="section-header">{section_name}</h2>\n'
                ...
                content += """
                        <div class="footer">
                            <p>Generated by _a2a (Linux System Info Tool) | © PearlK Tech</p>
                        </div>
                    </div>
                    <script>
            ...
            # Export the data
            utils.export_to_file(export_data, format_choice)
